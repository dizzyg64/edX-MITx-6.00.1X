    ...
    while (usr_command != 'e'):
        ...
        if (usr_command == 'n'):
            ...
            while (comp_command != 'c' and comp_command != 'u'):
                ...
                comp_command = input("Enter u to have yourself play, c to have the computer play: ")
            if (comp_command == 'c'):
            ...
            print("Invalid command")
        usr_command = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
